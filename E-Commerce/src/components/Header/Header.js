...
const Header = ({
  ...
  return (
    ...
    >
      <Container>
        <Navbar.Brand href="/home">shop anything</Navbar.Brand>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="mr-auto" activeKey={pathname}>
            ...
            >
              {[
                { label: 'Girls cloths', filter: 'rapala' },
                { label: 'Shirt', filter: 'heddon' },
                { label: 'T-shirt', filter: 'cottoncordel' },
                { label: 'Headphones & Mobiles', filter: 'rebel' },
                { label: 'Shoes', filter: 'mepps' },
